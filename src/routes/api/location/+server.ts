...
import { addDataUniqueId, fetchAllData, updateAllAttributes } from "$lib/scripts/dynamo";
...
export const GET: RequestHandler = async ({request, cookies}) => {
    ...
    try {
        let data = await fetchAllData("locations");
        console.log("Fetched data from 'locations' table:", data);
        return json(
            {
                statusCode: 200,
                body: { data }
...
//     layoutURL?: string;
// }
// function formatData(data:PlaceFormData, creator:User): Place {
//     let place:Place = {
